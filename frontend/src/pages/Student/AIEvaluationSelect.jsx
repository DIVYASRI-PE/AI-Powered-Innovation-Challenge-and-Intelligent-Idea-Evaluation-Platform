    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pt-24">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">AI Evaluation</h1>
            <p className="text-gray-500 text-sm">Select an idea to evaluate</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-10 text-center">
            ...
            <p className="text-gray-500 mb-6">Submit an idea first before getting it evaluated.</p>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {ideas.map((idea) => (
              <button
                key={idea.id}
                onClick={() => navigate(`/ai-evaluation/${idea.id}`)}
              ...
              >
                ...
                <div className="flex items-center text-violet-600 text-sm font-medium">
                  Evaluate this idea <ArrowRight className="w-4 h-4 ml-1" />
                </div>
              </button>
            ))}
          </div>
...
export default AIEvaluationSelect;
